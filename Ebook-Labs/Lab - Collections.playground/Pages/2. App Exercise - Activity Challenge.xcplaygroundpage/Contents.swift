 ...
 */
var RunningChallenges:[String] = ["Run 5 times a week", "Run 5 milles"]
var walkingChalenges:[String] = ["Walk 3 miles a day", "Walk 7 times a week"]
/*:
 ...
 */
var Challenges:[[String]] = [RunningChallenges, walkingChalenges]
...
} else if (availableChallenge.count == 1) {
    print("The challenge you have chosen is \(availableChallenge[0])")
} else {
